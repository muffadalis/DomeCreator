...
namespace DomeCreator
{
    ...
    /// for full explaination read http://agsmith.wordpress.com/2008/09/19/accessing-enum-members-in-xaml/
    /// </summary>
    public class EnumListExtension : MarkupExtension
    {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            foreach (object item in Enum.GetValues(_enumType))
            {
                ...
                FieldInfo field = _enumType.GetField(itemString);
